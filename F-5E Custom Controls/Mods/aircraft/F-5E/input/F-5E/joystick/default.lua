...
{	down = control_commands.SpdBrk,	up = control_commands.SpdBrk,   cockpit_device_id = devices.CONTROL_INTERFACE,	value_down = -1, value_up = 0,	name = _('3 Way - Speed Brake Switch - OUT'),			category = _('CUSTOM Throttle Quadrant')},
{	down = control_commands.SpdBrk,	up = control_commands.SpdBrk,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down = 1,	value_up = 0,	name = _('3 Way - Speed Brake Switch - IN'),					category = _('CUSTOM Throttle Quadrant')},
...
{	down = control_commands.FlapLever, up = control_commands.FlapLever,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down = 1.0, value_up = 0.0,	name = _('3 Way - Flap Lever - EMER UP'),			category = _('CUSTOM Throttle Quadrant')},
{	down = control_commands.FlapLever, up = control_commands.FlapLever,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down =-1.0, value_up = 0.0,	name = _('3 Way - Flap Lever - FULL'),				category = _('CUSTOM Throttle Quadrant')},
...
{	down = control_commands.FlapSwitch,	up = control_commands.FlapSwitch, cockpit_device_id = devices.CONTROL_INTERFACE,	value_down = 1.0, value_up = 0.0, name = _('3 Way - Flap Switch - UP'),				category = _('CUSTOM Throttle Quadrant')},
{	down = control_commands.FlapSwitch,	up = control_commands.FlapSwitch, cockpit_device_id = devices.CONTROL_INTERFACE,	value_down =-1.0, value_up = 0.0,	name = _('3 Way - Flap Switch - AUTO'),			category = _('CUSTOM Throttle Quadrant')},
...
{	down = fuel_commands.FuelShutoff_Left,				cockpit_device_id = devices.FUEL_INTERFACE,	value_down = 1.0,	name = _('Left Fuel Shutoff Switch - LEFT'),				category = {_('Left Vertical Panel')}},
{	down = fuel_commands.FuelShutoff_Left,				cockpit_device_id = devices.FUEL_INTERFACE,	value_down = 0.0,	name = _('Left Fuel Shutoff Switch - CLOSED'),				category = {_('Left Vertical Panel')}},
...
{	down = fuel_commands.FuelShutoff_Right,				cockpit_device_id = devices.FUEL_INTERFACE,	value_down = 1.0,	name = _('Right Fuel Shutoff Switch - RIGHT'),				category = {_('Left Vertical Panel')}},
{	down = fuel_commands.FuelShutoff_Right,				cockpit_device_id = devices.FUEL_INTERFACE,	value_down = 0.0,	name = _('Right Fuel Shutoff Switch - CLOSED'),				category = {_('Left Vertical Panel')}},
-- Int Lights
...
--
{	down = gear_commands.AltRelease_EXT,	cockpit_device_id = devices.GEAR_INTERFACE,	value_down = 1.0,	name = _('Landing Gear Alternate Release Handle - PULL/STOW'),	category = {_('Left Vertical Panel')}},
{	down = gear_commands.AltRelease,		cockpit_device_id = devices.GEAR_INTERFACE,	value_down = 1.0,	name = _('Landing Gear Alternate Release Handle - PULL'),		category = {_('Left Vertical Panel')}},
{	down = gear_commands.AltRelease,		cockpit_device_id = devices.GEAR_INTERFACE,	value_down = 0.0,	name = _('Landing Gear Alternate Release Handle - STOW'),		category = {_('Left Vertical Panel')}},
...
{	pressed = ecs_commands.CockpitAirInletHor_EXT,	cockpit_device_id = devices.ECS_INTERFACE,	value_pressed = -0.2,	name = _('Cockpit Air Inlet - Left'),					category = {_('Right Vertical Panel')}},
{	pressed = ecs_commands.CockpitAirInletHor_EXT,	cockpit_device_id = devices.ECS_INTERFACE,	value_pressed =  0.2,	name = _('Cockpit Air Inlet - Right'),					category = {_('Right Vertical Panel')}},
{	pressed = ecs_commands.CockpitAirInletVer_EXT,	cockpit_device_id = devices.ECS_INTERFACE,	value_pressed = -0.2,	name = _('Cockpit Air Inlet - Down'),					category = {_('Right Vertical Panel')}},
{	pressed = ecs_commands.CockpitAirInletVer_EXT,	cockpit_device_id = devices.ECS_INTERFACE,	value_pressed =  0.2,	name = _('Cockpit Air Inlet - Up'),						category = {_('Right Vertical Panel')}},
...
{	down = device_commands.Button_9,	cockpit_device_id = devices.TACAN,	value_down = 1,			name = _('TACAN Mode Selector Switch - CW'),		category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
{	down = device_commands.Button_9,	cockpit_device_id = devices.TACAN,	value_down = -1,		name = _('TACAN Mode Selector Switch - CCW'),		category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
...
{	pressed = iCommandPlane_TACAN_Chanel_Ones_Decrease,												name = _('TACAN Channel Ones - Decrease'),			category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
{	pressed = iCommandPlane_TACAN_Chanel_Ones_Increase,												name = _('TACAN Channel Ones - Increase'),			category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
{	pressed = iCommandPlane_TACAN_Chanel_Tens_Decrease,												name = _('TACAN Channel Tens - Decrease'),			category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
{	pressed = iCommandPlane_TACAN_Chanel_Tens_Increase,												name = _('TACAN Channel Tens - Increase'),			category = {_('ARN-118 TACAN Control Panel'), _('Pedestal Panels')}},
...
{action = sai_commands.CMD_SAI_PITCH_EXT,	cockpit_device_id = devices.SAI,	name = _('SAI Cage/Pitch Trim Knob'),										category = _('Instrument Panel')},

{action = iCommandPlaneRadarVerticalAbs,										name = _("Elevation Antenna Tilt Control, Rotate to adjust antenna tilt"),	category = _("Radar Control Panel")},
})
