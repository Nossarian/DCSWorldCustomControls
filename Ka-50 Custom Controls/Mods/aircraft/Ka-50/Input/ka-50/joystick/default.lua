...
{down = iCommandPlane_RouteMode, up = iCommandPlane_RouteMode, name = _('TOGGLE Engage/Disengage Route Mode'), category = _('Ins Collective Stick')},
{down = iCommandPlane_DescentMode, up = iCommandPlane_DescentMode, name = _('Engage Descent Mode'), category = _('Ins Collective Stick')},
