...
{down = iCommandPlaneRouteAutopilot, up = iCommandPlanceStabHorizon, name = _('Custom Path Autopilot Stuff'), category = _('Autopilot')},
{down = iCommandPlaneStabHbarBank, up = iCommandPlanceStabHorizon, name = _('Custom Alt Bank Autopilot Stuff'), category = _('Autopilot')},
...
{down = iCommandPlaneCobra, up = iCommandPlaneCobra, value_down = 1.0, value_up = 0.0, name = _('TOGGLE ASC Direct Control (Cobra)'), category = _('Flight Control')},
{down = iCommandPlaneCobra, name = _('ASC Direct Control (Cobra)'), category = _('Flight Control')},
{down = iCommandPlaneAirBrakeOn, up = iCommandPlaneAirBrakeOff, name = _('TOGGLE Airbrake'), category = _('TOGGLE')},
